...
class SearchService:
    ...
    def __init__(self):
        ...
        logger.info(
            f"✓ Elasticsearch connected: {settings.ELASTICSEARCH_HOST}:{settings.ELASTICSEARCH_PORT}"
        )
    ...
    async def hybrid_search(
        ...
        try:
            response = await asyncio.to_thread(
                self.client.search, index=settings.ELASTICSEARCH_INDEX, body=search_body
            )
